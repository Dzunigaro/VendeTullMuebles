    ...
    <header style="background-color: #f7cbb2">
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="indexUs.php">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="InmuebleUs.php">Inmueble</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="MapaUs.php">Mapa</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="ContactenosUs.php">Contactenos</a>
                        </li>
                    </ul>
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a class="btn btn-outline-primary" aria-current="page" href="usuario.php">Tu Perfil</a>
                        </li>
                    </ul>
                </div>
