    ...
    <div class="container">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            ...
                            <a href="Propiedad1Us.php" class="btn btn-primary">Ver más informacion</a>
                        </center>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            ...
                            <a href="Propiedad2Us.php" class="btn btn-primary">Ver más informacion</a>
                        </center>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            ...
                            <a href="Propiedad3Us.php" class="btn btn-primary">Ver más informacion</a>
                        </center>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            ...
                            <h6>Tipo de contrato: Fijo</h6>
                            <h6>Tipo de Vivienda: Casa en Residencial</h6>
                            <a href="Propiedad4Us.php" class="btn btn-primary">Ver más informacion</a>
                        </center>
                    </div>
                </div>
            </div>
                    ...
                    <center>
                        ...
                        <div class="card-body">
                            <center>
                                ...
                                <h6>Tipo de contrato: Arriendamineto</h6>
                                <h6>Tipo de Vivienda: Casa</h6>
                                <a href="Propiedad5Us.php" class="btn btn-primary">Ver más informacion</a>
                            </center>
                        </div>
                </div>
            </div>
                    ...
                    <center>
                        ...
                        <div class="card-body">
                            <center>
                                ...
                                <h6>Tipo de contrato: Fijo</h6>
                                <h6>Tipo de Vivienda: Casa en Residencial</h6>
                                <a href="Propiedad6Us.php" class="btn btn-primary">Ver más informacion</a>
                            </center>
                        </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            ...
                            <h6>Tipo de contrato: Fijo</h6>
                            <h6>Tipo de Vivienda: Casa</h6>
                            <a href="Propiedad7Us.php" class="btn btn-primary">Ver más informacion</a>
                        </center>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            ...
                            <h6>Tipo de contrato: Arriendamineto</h6>
                            <h6>Tipo de Vivienda: Casa</h6>
                            <a href="Propiedad8Us.php" class="btn btn-primary">Ver más informacion</a>
                        </center>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            ...
                            <a href="Propiedad9Us.php" class="btn btn-primary">Ver más informacion</a>
                        </center>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            ...
                            <h6>Tipo de contrato: Arriendamineto</h6>
                            <h6>Tipo de Vivienda: Casa</h6>
                            <a href="Propiedad10Us.php" class="btn btn-primary">Ver más informacion</a>
                        </center>
                    </div>
                </div>
            </div>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <li class="page-item"><a class="page-link" href="Inmueble2Us.php">2</a></li>
                <li class="page-item"><a class="page-link" href="Inmueble3Us.php">3</a></li>
            </ul>
        </nav>
    </div>
    </div>
