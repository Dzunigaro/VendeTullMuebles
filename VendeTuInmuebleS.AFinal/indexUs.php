...
<main style="background-color:#B0F8F6">
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <center><a class="btn btn-outline-primary" aria-current="page" href="Propiedad2Us.php">Volver
                                    a ver</a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <center><a class="btn btn-outline-primary" aria-current="page" href="Propiedad10Us.php">Volver
                                    a ver</a>
                            </center>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <center><a class="btn btn-outline-primary" aria-current="page" href="Propiedad15Us.php">Volver
                                    a ver</a>
                            </center>
                        </div>
                    </div>
        ...
        <div class="card mb-2" style="background-color:#f7cbb2">
            ...
            <center>
                <div class="col-sm-5 mb-5" ;>
                    ...
                    <FONT COLOR="brown" SIZE=5>Vende Tu Inmueble S.A. ofrece un exclusivo servicio inmobiliario
                        personalizado con
    ...
    <div class="container">
        ...
        <h1 align="center">Nuestras Propiedades</h1>
        <br>
        <br>
    ...
    <center>
        <div class="card mb-2" style="background-color:#f7cbb2">
            ...
            <center>
                <div class="col-sm-5 mb-5" ;>
                    <h1>Testimonios de nustros clientes</h1>
                        ...
                        <div class="col">
                            <div class="card" width="300" height="300">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">He tenido una experiencia muy buena con la compra de una casa.
                                        Desde la
                                        primera vez sientes que son un equipo de profesionales, saben colocar un precio
                                        acorde al mercado y
                                        en todo momento son realistas con los clientes aparte de que su servicio es muy
                                        rápido
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="card" width="350" height="300">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">My experience with the real estate agency has been very
                                        positive thanks
                                        to the care and professionalism with which they carry out their work. That they
                                        have people who
                        ...
                        <div class="col">
                            <div class="card" width="300" height="300">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Desde que me presente en la Inmobiliaria me sentí como en casa
                                        El trato
                                        es extraordinario, me hicieron la compra tan fácil. Gracias por vuestra
                                        profesionalidad a lo
                        ...
                        <div class="col">
                            <div class="card" width="300" height="300">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Nos remerciements et félicitations à toute l'équipe. Ils ont
                                        réussi à faire en
                                        sorte que
                                        l'achat de notre maison ressemble à quelque chose de simple, de la première
                                        visite à la
                                        signature de l'acte, ils n'ont pas cessé de nous serrer la main. Merci pour tout
                                    </p>
                                </div>
                            </div>
                        </div>
